...
start_positions = [2000, 2175, 2000, 825, 1900, 1100, 1800, 3100]
set_positions = [2000, 2175, 2000, 825, 1900, 1100, 1800, 3100]
...
def set_motor_independent_on_same_thread(id, position): 
    
    set_motor_position(id, position)


def get_motor_independent(id): 
    print(f"Motor {id } at position {get_motor_position(id)}")
