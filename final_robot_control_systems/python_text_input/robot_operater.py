...
def get_motor_independent(id): 
    motorPos = get_motor_position(id)
    print(f"Motor {id} is at position {motorPos}")
    return motorPos
...
def home_all_motors(): 
    ...
    confirm = yesNoInput('Are you sure you want to home all?')
